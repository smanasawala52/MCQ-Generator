...
def generate_home_page():
    ...
    search_query = st.text_input("Travel Query Assistant:", placeholder="Places to visit in dubai")
    images = [
        ...
        {"image_url": "images/static/Create_dubai_itinerary_with_desert_safari.jpg",
         "place": "Create dubai itinerary with desert_safari"},
